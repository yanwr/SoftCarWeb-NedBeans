<%-- 
    Document   : rodape
    Created on : 28/11/2019, 00:32:49
    Author     : Usuario
--%>
        ...
        <div class="pDiv">
            <div class="container">
                <ul class="list" >
                    ...
                    <li class="item">
                        <a class="btn-item" href="https://www.linkedin.com/in/yan-weschenfelder-169475181"
                            title="Yan Weschenfelder"  style="background-color: blueviolet;">
                            <i class="fab fa-linkedin-in btn-i"> </i>
                        </a>
                    </li>
                    <li class="item">
                        <a class="btn-item" href="https://www.linkedin.com/in/gleice-gonçalves-844675178 "
