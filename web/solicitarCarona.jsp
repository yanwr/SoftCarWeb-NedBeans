                     ...
                     if(w.getAssentos() != 0){
                        out.println("<div  class='card'>");
                          ...
                          out.println("</div>");
                           ...
                           // pegar codViagem e codUser e enviar para fazer a verificação
                            int codUser; int codViagem;
                            codUser= w.getCodUser();
                            codViagem = w.getCodViagem();
                            //
                          out.println("<div onclick='vericacao("+codUser+","+codViagem+")' class='dadosCorrida'>");
